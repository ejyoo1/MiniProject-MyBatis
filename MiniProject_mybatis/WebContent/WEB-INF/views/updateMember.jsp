	    ...
	    <div class="content">
	      <div class="container-fluid">
	       	<div class="row">
	              ...
	              <!-- /.card-header -->
	              <!-- form start -->
	              <form id="fm" method="post" action="updateMember">
	                <div class="card-body">
	                	<div class="form-group">
	                    <input type="text" name="userNo" class="form-control" id="userNo" value="${member.userNo}" hidden>
	                  </div>
	                	<div class="form-group">
	                  ...
	                  <div class="form-group">
	                    ...
	                    <input type="password" name="userPw" class="form-control" id="userPw" value="${member.userPw}">
	                  </div>
	                  <div class="form-group">
	                  ...
	                  <div class="form-group">
	                    ...
	                    <input type="email" name="userEmail" class="form-control" id="userEmail" value="${member.userEmail}"></td>
	                  </div>
	                </div>
	                <!-- /.card-body -->
